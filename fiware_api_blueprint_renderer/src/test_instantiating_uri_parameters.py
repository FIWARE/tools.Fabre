...
class TestInstantiatingURIParameters( unittest.TestCase ):
    ...
    def test_multiple_simple_uri_parameters(self):
        ...
        self.assertEqual(renderer.instantiate_uri('/Entity/{id}/{name}', parameters), '/Entity/15/entity-name')
    ...
    def test_multiple_form_style_uri_parameters(self):
        ...
        self.assertEqual(renderer.instantiate_uri('/Entity/{?id,name}', parameters), '/Entity/?id=15&name=entity-name')
    ...
    def test_plus_uri_parameters(self):
        ...
        self.assertEqual(renderer.instantiate_uri('/Entity/{+resource_path}', parameters), '/Entity/path/to/resource')
