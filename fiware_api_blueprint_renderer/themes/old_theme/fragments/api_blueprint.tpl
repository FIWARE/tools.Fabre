    ...
    {% for resource in resourceGroup.resources %}
        ...
        <h4>Actions</h4>
            {% for action in resource.actions %}
                <div id="{{ slug( action.name ) }}" class="action-div col-md-12">
                    <div class="row action-div-header">
                        ...
                        <div class="col-md-2 toggle-button">
                            <a href="#{{ slug( action.name ) }}_body" class="btn btn-default" data-toggle="collapse">Details</a>
                        </div>
                    </div>

                    <div id="{{ slug( action.name ) }}_body" class="collapse action-div-body row">
                        <div class="col-md-12">
